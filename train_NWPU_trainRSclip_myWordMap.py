...
def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--data', default='../dataset/NWPU_Captions_dataset/train_image_raw_captions.pkl')
    parser.add_argument('--data_root', default='../dataset/NWPU_Captions_dataset/img')
    parser.add_argument('--out_dir', default='./results_NWPU')
