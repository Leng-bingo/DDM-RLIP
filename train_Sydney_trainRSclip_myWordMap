...
def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--data', default='../dataset/Sydney_Caption/train_image_raw_captions.pkl')
    parser.add_argument('--data_root', default='../dataset/Sydney_Caption/img')
    parser.add_argument('--out_dir', default='./results_Sydney')
